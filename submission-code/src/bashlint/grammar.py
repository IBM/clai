...
key = 'GRAMMAR_FILEPATH'
default_fp = os.path.join(os.path.dirname(__file__), 'grammar', 'grammar100.txt')
grammar_fp = os.environ.get(key, default_fp)
print(f'Setting bashlex grammar using file: {grammar_fp}')

bg = BashGrammar()
bg.make_grammar(grammar_fp)
